...
- Softeners: "might be worth", "you may find it useful"
- Direct questions: "Would you be the best contact?"
...
- Always connect to their specific use case
...
- "No worries if this doesn't resonate"
- "just thought it was worth sending your way"
- "Cheers,"
...
**Feature Requests:**
1. Summarized stats for events older than X time
2. MaxAI integration into Slack
3. More visibility on transformation impacts
```
...
- How users react when models have issues
- A/B test different prompts to measure impact
```

## Never Do

- ❌ Multiple follow-ups without value add
- ❌ Long paragraphs without breaks
- ❌ Pushy sales language
- ❌ Formal corporate tone
- ❌ Apologize more than once
- ❌ Use full signature blocks in replies
- ❌ Write "salesy" subject lines

## Remember

The goal is to be helpful, not to sell. Write like you're genuinely trying to help a colleague solve their problems with the tools available. Keep it human, keep it real, keep it valuable.
